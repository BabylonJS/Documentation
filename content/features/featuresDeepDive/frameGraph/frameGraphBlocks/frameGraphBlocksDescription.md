...
![Texture creation parameters](/img/frameGraph/texture_creation_params.webp)
...
![Example of post-process blocks](/img/frameGraph/source_target_inputs.webp)
...
![Parameters of DoF](/img/frameGraph/dof_parameters.webp)
...
<H3Image title="SSR (Screen Space Reflection)" image="/img/frameGraph/ssr.webp" alt="SSR node"/>

This block allows you to apply a Screen Space Reflection post-process to a given texture.

The first thing to note is that **geomDepth** and **geomBackDepth** allow a view or screen space depth geometry texture, and **geomNormal** allows a view or world space normal geometry texture: as explained in [this section](/features/featuresDeepDive/frameGraph/frameGraphBlocks/frameGraphBlocksGeneralNotes#inputs-allowing-several-types-of-connection), you can see all the accepted connection types by clicking on the circle icon representing the connection point.
...
![SSR setup for automatic thickness computation](/img/frameGraph/ssr_auto_thickness.webp)

<NRGE id="#L75VY0#53" title="Using SSR in a node render graph" description="SSR setup for automatic thickness computation" isMain={true} category="NodeRenderGraph"/>
...
<Playground id="#PIZ1GK#2391" image="/img/playgroundsAndNMEs/pg-PIZ1GK-2094.webp" title="Using SSR in a node render graph" description="Example of a node render graph using SSR with automatic thickness computation" isMain={true} category="Frame Graph"/>
...
<H3Image title="TAA (Temporal Anti-Aliasing)" image="/img/frameGraph/block_taaobjectrenderer.webp" alt="TAA node"/>
...
<H3Image title="ObjectRenderer" image="/img/frameGraph/block_objectrenderer.webp" alt="ObjectRenderer node"/>
...
![Blocks with geometry textures as inputs](/img/frameGraph/blocks_input_geomtexture.webp)
...
<H3Image title="ShadowGenerator and CascadedShadowGenerator" image="/img/frameGraph/block_shadowgenerator.webp" alt="ShadowGenerator and CascadedShadowGenerator nodes"/>
...
<H3Image title="GlowLayer and HighlightLayer" image="/img/frameGraph/block_layers.webp" alt="GlowLayer and HighlightLayer nodes"/>
...
<Playground id="#IG8NRC#90" image="/img/playgroundsAndNMEs/pg-IG8NRC-16.webp" title="Use of the GlowLayer block (PG)" description="Example of a node render graph using the GlowLayer block" isMain={true} category="Frame Graph"/>
...
<H3Image title="Clear" image="/img/frameGraph/block_cleartexture.webp" alt="Clear node"/>
...
<H3Image title="CopyTexture" image="/img/frameGraph/block_copytexture.webp" alt="CopyTexture node"/>
...
<H3Image title="GenerateMipmaps" image="/img/frameGraph/block_generatemipmaps.webp" alt="GenerateMipmaps node"/>
...
<H3Image title="Cull" image="/img/frameGraph/block_cull.webp" alt="Cull node"/>
...
<H3Image title="Execute" image="/img/frameGraph/block_execute.webp" alt="Execute node"/>
...
<H3Image title="GUI" image="/img/frameGraph/block_gui.webp" alt="GUI node"/>
...
![Use of the ResourceContainer block](/img/frameGraph/multiple_shadowgenerators.webp)

<H3Image title="Output" image="/img/frameGraph/block_output.webp" alt="Output node"/>
...
![Disabled Output block](/img/frameGraph/output_disabled.webp)
