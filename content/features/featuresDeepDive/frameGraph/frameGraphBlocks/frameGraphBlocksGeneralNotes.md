...
![Blocks with optional "target" input](/img/frameGraph/source_target_inputs.webp)
...
![Blocks with mandatory "target" input](/img/frameGraph/target_only_inputs.webp)
...
![Basic graph](/img/frameGraph/basic_graph.webp)
...
![The dependencies input](/img/frameGraph/dependencies_input.webp) <span url="https://nrge.babylonjs.com/#PSA9PS#157"/>
...
![Geometry Renderer block](/img/frameGraph/block_geometry_renderer.webp)
