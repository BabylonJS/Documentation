...
```
The full PG: <Playground id="#CP2RN9#322" image="/img/playgroundsAndNMEs/pg-CP2RN9-293.png" title="VAT and frame graph" description="VAT working when using a frame graph" isMain={false} image="/img/playgroundsAndNMEs/pg-VI0JUJ-3.png"/>
...
PG: <Playground id="#CP2RN9#323" image="/img/playgroundsAndNMEs/pg-CP2RN9-300.png" title="VAT and frame graph (NRG)" description="VAT working when using a frame graph (NRG)" isMain={false} image="/img/playgroundsAndNMEs/pg-VI0JUJ-3.png"/>
