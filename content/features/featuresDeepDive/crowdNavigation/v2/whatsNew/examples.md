...
<Playground id="#DPDNVH#1" title="Basic navigation mesh creation" description="Show the basics of navmesh creation" category="Navigation"/>
...
<Playground id="#DPDNVH#5" title="Offmesh connections aka Teleports" description="Shows how to use Teleports/Bridges" category="Navigation"/>
...
<Playground id="#DPDNVH#7" title="Raycast" description="Showcases raycast functionality" category="Navigation"/>
