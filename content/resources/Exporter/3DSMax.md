...
The _Use Draco comression_ option is only available for gltf and glb output format. More detail [here](/workflow/wfDeeper/Exporters/3DSMax_to_glTF#draco-compression).
...
To ensure that bones are correctly exported, you have to use the Skin modifier. Skin should be positioned at origin. [More info here](/workflow/wfDeeper/Exporters/Bones_influences_per_vertex)
...
The handling of physical materials is mimic from glTF format. [Detailed explanations here](/workflow/wfDeeper/Exporters/3DSMax_to_glTF#pbr-materials)

## Arnold materials

The handling of arnold materials is mimic from glTF format. [Detailed explanations here](/workflow/wfDeeper/Exporters/3DSMax_to_glTF#standard-surface-arnold-material)
...
The handling of the shell material is mimic from glTF format. [Detailed explanations here](/workflow/wfDeeper/Exporters/3DSMax_to_glTF#shell-material)

## DirectX Shader

The handling of the directX shader material is mimic from glTF format. [Detailed explanations here](/workflow/wfDeeper/Exporters/3DSMax_to_glTF#directx-shader-material)
...
**Important:** if you are relying on a physically based material, you can chose the transparency mode through a dedicated material attribute. You can refer to the [following documentation](/workflow/wfDeeper/Exporters/3DSMax_to_glTF#alpha-mode) to learn more about this feature.
