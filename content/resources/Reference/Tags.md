...
All tags added to meshes, cameras, lights... are saved to the scene files (see [.babylon file format](/features/advanced_topics/.babylonFileFormat) and reloaded from them.
