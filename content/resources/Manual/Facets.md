...
further-reading:
    - title: Calculating UVs
      url: /features/divingDeeper/mesh/creation/custom/custom
...
Of course with a mesh consisting of many vertices wrapping an image as texture around the mesh will mean each vertex being assigned a point on the image using fractional values as described in [custom meshes](/features/divingDeeper/mesh/creation/custom/custom#calculating-uvs).
