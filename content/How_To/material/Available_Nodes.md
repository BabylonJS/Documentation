...
-   Scene Attributes:
    ...
    -   `ImageProcessing`: Provides access to all of the Babylon image processing properties. Input is expected in Gamma color space. [Post Processes](/features/divingDeeper/postProcesses/usePostProcesses)
