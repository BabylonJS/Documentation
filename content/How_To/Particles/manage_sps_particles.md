...
This can be used both by all the custom functions the *positionFunction* and *updateParticle()*, whichever you are using. It is most usefult when the image is a texture atlas.
