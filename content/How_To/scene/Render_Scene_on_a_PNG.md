...
You also need to consider how you will trigger the screenshot. This can be done for example with a timer such as 'window.setTimeout' or by using the [Babylon.js action manager](/features/divingDeeper/events/actions) for a keyDown or onPointerDown trigger.
