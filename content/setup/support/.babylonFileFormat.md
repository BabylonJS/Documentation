...
[
{
	...
	"texture": {
		...
		"vAng": int,
		"wAng": int,
		"uRotationCenter": float,
		"vRotationCenter": float,
		"wRotationCenter": float,
		...
		"wrapV": float,
		"wrapR": float,
		"anisotropicFilteringLevel": float,
		"isCube": boolean,
		"is3D": boolean,
		"is2DArray": boolean,
		"gammaSpace": boolean,
		...
		"lodGenerationOffset": int,
		"lodGenerationScale": int,
