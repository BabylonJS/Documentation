...
The [lines](/features/divingDeeper/mesh/creation/param#lines) and [line system](/features/divingDeeper/mesh/creation/param#line-system) methods just produce a thin line and you cannot vary the width. The best way to simulate a line with a given width in 3D is to use a [tube](/features/divingDeeper/mesh/creation/param#tube).
