...
further-reading:
    - title: Node Material
      url: /How_To/material/Node_Material
...
You can jump in and play around with it here: <nme id="" title="Node Material Editor" description="The starting basic template for creating Node Materials." image=""/>
