...
-   .basis texture file format support [Doc](/features/advanced_topics/mutliPlatTextures#basis-file-format) ([TrevorDev](https://github.com/TrevorDev))
-   Navigation mesh and crowd of moving agents [Doc](/features/extensions/crowdNavigation/createNavMesh) ([CedricGuillemet](https://github.com/CedricGuillemet))
...
-   Migrated the code to modules and deploy [ES6 npm packages](/features/divingDeeper/developWithBjs/treeShaking) ([Sebavan](https://github.com/Sebavan))
...
-   New [Babylon.js](//doc.babylonjs.com/features/extensions/Exporters/Maya) and [glTF](//doc.babylonjs.com/features/extensions/Exporters/Maya_to_glTF) exporter for Autodesk Maya ([Noalak](https://github.com/Noalak))
-   New [glTF exporter](//doc.babylonjs.com/features/extensions/Exporters/3DSMax_to_glTF) for Autodesk 3dsmax ([Noalak](https://github.com/Noalak))
-   New glTF [serializer](//doc.babylonjs.com/features/extensions/gltfexporter). You can now export glTF or glb files directly from a Babylon scene ([kcoley](https://github.com/kcoley))
...
-   Introducing theBabylon.js viewer, an HTML-based 3D/model viewer, with Babylon at its core. [Documentation](//doc.babylonjs.com/features/extensions/the_babylon_viewer) ([RaananW](https://github.com/RaananW))
...
-   Multi-platform Compressed Textures for Desktops & Mobile Devices with fall back. Batch (dos) scripts to convert entire directories of .jpg's & .png's [Doc](//doc.babylonjs.com/features/advanced_topics/mutliPlatTextures) ([jcpalmer](https://github.com/Palmer-JC))
...
-   Introducing [Materials Library](https://github.com/BabylonJS/Babylon.js/tree/master/materialsLibrary) ([deltakosh](https://github.com/deltakosh))
    ...
    -   PBR Material: //doc.babylonjs.com/features/extensions/pbr ([deltakosh](https://github.com/deltakosh))
    -   Fur Material: //doc.babylonjs.com/features/extensions/Fur. [Demo here](https://www.babylonjs.com/Demos/Fur/) ([julien-moreau](https://github.com/julien-moreau))
