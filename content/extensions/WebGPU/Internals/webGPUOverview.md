...
This class implements a cache of GPU bind groups. The cache is a node tree:
```typescript
...
#### Cache implementation
This class implements a cache of GPU render pipelines. The cache is a node tree with the same structure than the bind group cache:
```typescript
class NodeState {
